...
export const useCart = (tenantSlug: string) => {
  ...
  // for arrays standard comparison does not work
  // [1,2] !== [1,2] always, for this purpose useShallow is used

  // converted function to a memoized version using useCallback
